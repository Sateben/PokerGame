...
public class PokerX8v2 {
    ...
    public static char[][] rules(ArrayList<Character>rancard, ArrayList<Character>rancardsuite) // this is done to ensure that no card (card value+card suite) is repeated.. 
    {
        ...
        int rancardint1[] = new int [rancard1.length];
        int rancardsuiteint1[] = new int [rancardsuite1.length];
        for(int count = 0; count < rancard1.length; count++)
        {
            rancardint1[count] = 0 + rancard1[count];
            rancardsuiteint1[count] = 0 + rancardsuite1[count];
        }
        
        for(int count = 0; count < rancard1.length; count++)
        {
        System.out.println(rancardint1[count] + " and the suit is " + rancardsuiteint1[count]);
        }
        return totalrancard;

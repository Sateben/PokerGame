...
public class PokerX6 {
        ...
        for(int count1=0; count1 < rancard1.length; count1++)
        {
            for(int count2 = 0; count2 < rancard1.length;count2++)
                if(count2 != count1)
                {
                   ...
                   {
                       for(int count3=0; count3 < rancardsuite1.length; count3++)
                       {
                           for(int count4=0; count4 < rancardsuite1.length; count4++)
                           {
                               if(count4 != count3)
                               {
                                if(rancardsuite1[count3] == rancardsuite1[count4])
                                {
        ...
        while(checker2 == false)
        {
            ...
            if(Bet.hasNextInt())
            {
                ...
                System.out.println(" TYPHOON ");
                    checker2 = true;
                    System.out.println("GOD MADE MAN");
            }
            else
            {
                System.out.println("Please enter an numerical value for the total amount of money you wish to bet ");
   ...
   public static int userbetcontinue(int ubet, int bet)
   {
       ...
       while(checker1 == false)
       {
           if(Bet.hasNextInt())
           {
               ...
               {
                   int tempubet = ubet;
                   System.out.println(tempubet + "   Hello");
                   
                   while(checker2 == false)
                   {
                       System.out.println("Please input a number equal to or greater than "+(bet-tempubet));
                       ubet = userbetting(ubet);
                       System.out.println(ubet);
                      
                       if((tempubet-ubet) >= (bet-tempubet) || (tempubet-ubet) == 0)
                       {
                       ...
                       {
                           System.out.println("Please enter a valid bet 12");
                           Bet.next();
                       }
                   }
   ...
   public static int postraise()
   {
      ...
      {
          System.out.println("");
          System.out.println("Please choose one of the two following functions: ");
          System.out.println("1. Check");
          System.out.println("2. Fold");
          
          if(Bet.hasNextInt())
          {
              inputter = Bet.nextInt();
              checker1 = true;
          }
          else
              System.out.println("Please input a valid function number");
          
      }
      
      if(inputter == 2)
          inputter = 3; // since fold function = 3 in the main method.

...
//objective of PokerX3 is to add the concept of unique cards to the Poker game as well as clean the code that this generates.

public class PokerX3 {
    ...
    public static void main(String[] args) {
     ...
     cardupdater(totalcard,syscard);
     cardsuiteupdater(totalcardsuite,syscardsuite);
     intro();
     for(int count = 0; count < ucardsuite.length; count++)
         totalcardsuite.add(ucardsuite[count]);
     for(int count = 0; count < syscardsuite.length; count++)
    ...
    public static char[][] rules(ArrayList<Character>rancard, ArrayList<Character>rancardsuite)
    {
    ...
    public static ArrayList<Character> totalcardarraytolistconverter(ArrayList<Character>totalcard,ArrayList<Character>totalcardsuite)
    {
    ...
    {
        int counter = totalcardsuite.size()-rancardsuite.length;
